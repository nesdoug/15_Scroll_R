...
; BoxGuy1.vel_y = 0;
;
L073F:	sta     _BoxGuy1+6
	stx     _BoxGuy1+6+1
;
; BoxGuy1.y += BoxGuy1.vel_y;
;
L05FB:	lda     _BoxGuy1+6
	clc
	adc     _BoxGuy1+2
	sta     _BoxGuy1+2
	lda     _BoxGuy1+6+1
...
;
L0696:	ldy     _coordinates
	lda     _c_map2,y
L0759:	sta     _collision
;
; }
;
	rts
